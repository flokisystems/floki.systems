...
Welcome to Floki - the first truly comunity token with continuos funds to allow development without the fear of developer's dump!
...
Hold on to your $FLOKI$ and meet you on the Moon!
...
contract Floki$ is Context, IBEP20, Ownable {
    ...
    string  private _NAME = "Floki.systems";
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(
            ...
            !(sender == address(this) && recipient == address(PancakeSwapV2Pair))
         ) {
    ...
    function withdrawToken(address _tokenAddress, address recipient) public onlyOwner(){
        require(recipient != address(0), "BEP20: transfer to the zero address");
        uint256 balance = IBEP20(_tokenAddress).balanceOf(address(this));
        IBEP20(_tokenAddress).transfer(recipient, balance);
